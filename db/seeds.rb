...
# SEEDS DONE
hugoboss = Listing.create!(category: "Men",title: "Suit, Hugo Boss", description: "New Suit, never wear. Perfect for a wedding", size: "52", price: "250", location: "London", brand: "Hugo Boss", user: jules )
...
# SEEDS DONE
defrusac = Listing.create!(category: "Men", title: "Beige Suit, 3 pieces", description: "Beige Suit, perfect for the summer" , size: "48", price: "320", location: "Amsterdam", brand: "De Frusac", user: grant )
...
# # SEEDS DONE
# hawes = Listing.create!(category: "Men", title: "Navy Suit", description: "Navy Suit, perfect for the summer", size: "50", price: "170", location: "New York", brand: "Hawes and Curtis", user: eric )
...
# # SEEDS DONE
# cos = Listing.create!(category: "Men", title: "Casual Suit", description: "Casual Suit perfect for everyday or a country wedding", size: "50", price: "70", location: "Paris", brand: "Cos", user: grant )
...
# # SEEDS DONE
# isaacdewhirst = Listing.create!(category: "Men", title: "3 Pieces Suit", description: "Nice 3 pieces suit", size: "50", price: "60", location: "London", brand: "Isaac Dewhirst", user: jules )
...
# # SEEDS DONE
# calvinklein = Listing.create!(category: "Men", title: "Blue Suit for wedding", description: "Blue Suit for wedding", size: "50", price: "80", location: "Paris", brand: "Lindbergh ", user: grant )
...
# # SEEDS DONE
# lindbergh = Listing.create!(category: "Men", title: "Blue Suit for wedding", description: "Blue Suit for wedding", size: "50", price: "80", location: "Paris", brand: "Lindbergh ", user: grant )
